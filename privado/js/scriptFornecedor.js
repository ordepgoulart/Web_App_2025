    ...
    if (listaDeFornecedores.length === 0){
        ...
        for (let i=0; i < listaDeFornecedores.length; i++){
            ...
            linha.innerHTML=`
                ...
                <td><button type="button" class="btn btn-danger" onclick="excluirFornecedores('${listaDeFornecedores[i].nome}','${listaDeFornecedores[i].id}','${listaDeFornecedores[i].cnpj}')"><i class="bi bi-trash"></i></button></td>
            `;
